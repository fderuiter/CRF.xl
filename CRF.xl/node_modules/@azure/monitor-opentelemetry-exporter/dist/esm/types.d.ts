 ...
 * @internal
 */
export declare const httpSemanticValues: ("exception.type" | "exception.message" | "exception.stacktrace" | "client.address" | "client.port" | "server.address" | "server.port" | "url.full" | "url.path" | "url.query" | "url.scheme" | "error.type" | "network.local.address" | "network.local.port" | "network.protocol.name" | "network.peer.address" | "network.peer.port" | "network.protocol.version" | "network.transport" | "user_agent.original" | "http.request.method" | "http.response.status_code" | experimentalOpenTelemetryValues)[];
/**
