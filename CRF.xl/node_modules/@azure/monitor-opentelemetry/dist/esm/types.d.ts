...
export declare const AZURE_MONITOR_OPENTELEMETRY_VERSION = "1.18.0";
 ...
 * @internal
 */
export declare const APPLICATIONINSIGHTS_SDKSTATS_DISABLED = "APPLICATIONINSIGHTS_SDKSTATS_DISABLED";
